' Copyright (c) 2015 nguyentech.com
'  All rights reserved.
' 
...
' are accessible to your module's controls (that inherity from NguyenTech_AutoLoginModuleBase
' 
' </summary>

Public Class AutoLoginSettingsBase
